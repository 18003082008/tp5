<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:59:"E:\new_gmsh\public/../application/admin\view\vip\index.html";i:1517816755;s:51:"E:\new_gmsh\application\admin\view\Public\meta.html";i:1517816088;}*/ ?>
﻿<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray"> <span class="l"> <a class="btn btn-primary radius" href="javascript:;" onclick="admin_role_add('添加角色','vip_add.html','800')"><i class="Hui-iconfont">&#xe600;</i> 添加套餐</a> </span>  </div>
