<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"E:\new_gmsh\public/../application/admin\view\goods\good_add.html";i:1518441698;s:51:"E:\new_gmsh\application\admin\view\Public\meta.html";i:1517816088;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<div class="page-container">
	<form action="<?php echo url('good_add'); ?>" method="post" class="form form-horizontal" id="form-article-add">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="shorttitle">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="privilege_price" id="" placeholder="" value="" class="input-text" style="width:90%">
				元</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="ship_fee" id="" placeholder="" value="" class="input-text" style="width:90%">元
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">可用积分：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="score_price" id="" placeholder="" value="" class="input-text">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="radio-box">
					<input name="is_vip" type="radio" id="sex-1" value="1">
					<label for="sex-1">是</label>
				</div>
				<div class="radio-box">
					<input type="radio" id="sex-2" name="is_vip" checked value="0">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="commission1" id="" placeholder="" value="" class="input-text" style="width:90%">
				</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="commission2" id="" placeholder="" value="" class="input-text" style="width:90%">
				</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">三级佣金比例：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="commission3" id="" placeholder="" value="" class="input-text" style="width:90%">
				</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">返积分比例：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="score_rate" id="" placeholder="" value="" class="input-text" >
				</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">每天奖励金额：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="day_award" id="" placeholder="" value="" class="input-text" style="width:90%">
				元</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">获利周期：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="N_day" id="" placeholder="" value="" class="input-text" style="width:90%">
				天</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">开售时间：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="time" id="datemin" name="start_time"  style="width:180px;">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">停售时间：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="time" id="datemax" name="end_time" style="width:180px;">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">每日销售数量：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" name="day_num" id="" placeholder="" value="" class="input-text">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">每人每天最大购买量：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" name="max_num" id="" placeholder="" value="" class="input-text">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">一键访问京东链接：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="pkurl" id="" placeholder="" value="" class="input-text">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="radio-box">
					<input name="COD" type="radio" id="sex-1" value="1">
					<label for="sex-1">支持</label>
				</div>
				<div class="radio-box">
					<input type="radio" id="sex-2" name="COD" checked value="0">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="sold" id="" placeholder="" value="" class="input-text">
			</div>
		</div>
		<div class="row cl">
