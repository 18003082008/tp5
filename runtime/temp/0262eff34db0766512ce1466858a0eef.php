<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:61:"E:\new_gmsh\public/../application/admin\view\index\index.html";i:1517818520;s:51:"E:\new_gmsh\application\admin\view\Public\meta.html";i:1517816088;s:53:"E:\new_gmsh\application\admin\view\Public\header.html";i:1517826127;s:52:"E:\new_gmsh\application\admin\view\Public\aside.html";i:1517984493;s:53:"E:\new_gmsh\application\admin\view\Public\footer.html";i:1517825973;}*/ ?>
﻿<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
    ...
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">H-ui.admin</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a>
            ...
            <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
                ...
                <ul class="cl">
                    <a href="<?php echo url('cache_clear'); ?>" class="btn btn-primary radius f-l" style="margin-top:6px">清除缓存</a>
                    <li>管理员</li>
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        ...
        <dl id="menu-system">
            ...
            <dd>
                <ul>
                    <li><a data-href="system_base.html" data-title="系统设置" href="javascript:void(0)">系统设置</a></li>
    ...
    <div class="menu_dropdown bk_2" style="display:none">
        <dl id="menu-aaaaa">
            ...
            <dd>
                <ul>
                    <li><a data-href="<?php echo url('Vip/vip_list'); ?>" data-title="VIP套餐" href="javascript:void(0)">VIP套餐</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-product">
            ...
            <dd>
                <ul>
                    <li><a data-href="<?php echo url('Goods/good_list'); ?>" data-title="商品管理" href="javascript:void(0)">商品列表</a></li>
                    <li><a data-href="<?php echo url('Goods/attribute_list'); ?>" data-title="商品属性" href="javascript:void(0)">商品属性</a></li>
                    <li><a data-href="<?php echo url('Goods/good_category'); ?>" data-title="商品类别" href="javascript:void(0)">商品类别</a></li>
