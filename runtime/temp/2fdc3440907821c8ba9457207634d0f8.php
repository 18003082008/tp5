<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"E:\new_gmsh\public/../application/admin\view\login\login.html";i:1517368342;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
    ...
    <form class="form form-horizontal" action="<?php echo url('index'); ?>" method="post">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          ...
          <img src="<?php echo captcha_src(); ?>" alt="captcha" onclick="this.src='<?php echo captcha_src(); ?>?'+Math.random();" /> </div>
      </div>
      <!--<div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <label for="online">
